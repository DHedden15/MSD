...
$ git clone https://github.com/rdimaio/lee-py
```
...
An additional great reference is the script file from [Charles Hayen's Java implementation of ELIZA](http://chayden.net/lee/Eliza.html).
...
- The script file from [Charles Hayen's Java implementation of ELIZA](http://chayden.net/lee/Eliza.html)
